...
| Decisão | O que muda no Instant Channel | Onde está registrada |
|---|---|---|
...
**O que não muda:** as três regras invioláveis de tenancy, o congelamento do módulo de agenda (que agora também sai da superfície do produto por sinalizador, porque o menu de agendamento confunde um distribuidor), as guardas do motor de IA, e o contrato v1 com o Instant ERP.
